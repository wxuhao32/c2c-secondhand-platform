INSERT IGNORE INTO users (id, username, password, mobile, email, nickname, avatar, status, role, last_login_time, last_login_ip) VALUES
...
INSERT IGNORE INTO category (id, name, parent_id, icon, sort_order) VALUES
(1, '数码电子', 0, '💻', 1),
(2, '手机', 1, '📱', 1),
(3, '电脑', 1, '💻', 2),
(4, '相机', 1, '📷', 3),
...
INSERT IGNORE INTO goods (id, seller_id, title, description, price, original_price, category_id, images, status, view_count, like_count) VALUES
...
INSERT IGNORE INTO orders (id, order_no, buyer_id, seller_id, goods_id, price, status, address, remark) VALUES
...
INSERT IGNORE INTO favorite (id, user_id, goods_id) VALUES
(1, 3, 1),
(2, 3, 2),
(3, 2, 5),
(4, 2, 7);

INSERT IGNORE INTO message (id, sender_id, receiver_id, type, title, content, is_read) VALUES
