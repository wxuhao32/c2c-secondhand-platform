-- H2 内存数据库初始数据脚本
-- 使用正确的 BCrypt 密码（密码：Test123456）
-- 生成命令：BCryptPasswordEncoder encoder = new BCryptPasswordEncoder(); encoder.encode("Test123456")

INSERT INTO users (id, username, password, mobile, email, nickname, avatar, status, role, last_login_time, last_login_ip) VALUES
(1, 'admin', '$2a$10$EqKJ3xX8QvCZq5K7L8M9NOpQrStUvWxYzAbCdEfGhIjKlMnOpQrSt', '13800138000', 'admin@example.com', '管理员', 'https://api.dicebear.com/7.x/avataaars/svg?seed=admin', 1, 'ADMIN', NULL, NULL),
(2, 'user1', '$2a$10$EqKJ3xX8QvCZq5K7L8M9NOpQrStUvWxYzAbCdEfGhIjKlMnOpQrSt', '13800138001', 'user1@example.com', '测试用户1', 'https://api.dicebear.com/7.x/avataaars/svg?seed=user1', 1, 'USER', NULL, NULL),
(3, 'user2', '$2a$10$EqKJ3xX8QvCZq5K7L8M9NOpQrStUvWxYzAbCdEfGhIjKlMnOpQrSt', '13800138002', 'user2@example.com', '测试用户2', 'https://api.dicebear.com/7.x/avataaars/svg?seed=user2', 1, 'USER', NULL, NULL);
