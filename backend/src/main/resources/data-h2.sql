-- H2 内存数据库初始数据脚本（生产环境用）
-- 使用 MERGE INTO 避免重复插入主键冲突
...
-- 插入测试收藏
MERGE INTO favorite (id, user_id, goods_id) KEY(id) VALUES
(1, 3, 1),
(2, 3, 2),
(3, 2, 5),
(4, 2, 7);
...
-- 插入测试消息
MERGE INTO message (id, sender_id, receiver_id, type, title, content, is_read) KEY(id) VALUES
